...
static int parse(sox_effect_t *effp, int argc, char **argv)
{
  ...
  lsx_warn("sox_trim_parse  end!!!\n");
  return SOX_SUCCESS;
}

static int start(sox_effect_t *effp)
{
  lsx_warn("sox  trim  start!!!\n");
  priv_t *p = (priv_t*) effp->priv;
